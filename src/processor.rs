...
const PREFIX: &str             = "stdao_minter";
const OUR_PUB_KEY: &str        = "9FixCU9u5K1o9NKjMeZQS1fR5E4wrPRaU4exihBCaPTo";
// Wallet is the public key of the account where the funds go
const OUR_WALLET: &str         = "9FixCU9u5K1o9NKjMeZQS1fR5E4wrPRaU4exihBCaPTo";

// TESTNET
const MINT_KEY: &str           = "8VigsUivA2wT8foDr8nYKUo8KhJZAu3Q9KcjEBpDRVyN";
const DISCOUNT_KEY: &str       = "645tt6wDJxu7kMUXJiQKaA8VWmBieuydfwuS2zNbLRHy";


const PRICE: u64               = 300000000; // .3 sol

#[derive(BorshSerialize, BorshDeserialize, Debug)]
pub struct StdaoIndex {
    pub counter: u16,
}
...
pub fn process_instruction<'a>(
    ...
    // Iterating Over Accounts to fetch the required accounts
    ...
    let mut series_index = StdaoIndex::try_from_slice(&index_account.data.borrow())?;

    // Only 300 NFTs can be minted
    if series_index.counter == 300 {
        return Err(MintError::NoneLeft.into());
    }

    // Unpack token_account and mint_data
    ...
    let release_time: i64   = 1659783457;
    // TEST TIME
    ...
    let uri_prefix = match str::from_utf8(_input) {
        Ok(v) => v,
